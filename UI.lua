...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Sunset = {
			...
			Topbar = Color3.fromRGB(255, 94, 77),
			Shadow = Color3.fromRGB(255, 94, 77),

			NotificationBackground = Color3.fromRGB(255, 94, 77),
			NotificationActionsBackground = Color3.fromRGB(230, 230, 230),

			TabBackground = Color3.fromRGB(255, 94, 77),
			TabStroke = Color3.fromRGB(255, 94, 77),
			TabBackgroundSelected = Color3.fromRGB(210, 210, 210),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(50, 50, 50),

			ElementBackground = Color3.fromRGB(255, 94, 77),
			ElementBackgroundHover = Color3.fromRGB(255, 94, 77),
			SecondaryElementBackground = Color3.fromRGB(255, 94, 77),
			ElementStroke = Color3.fromRGB(50, 50, 50),
			SecondaryElementStroke = Color3.fromRGB(255, 94, 77),
